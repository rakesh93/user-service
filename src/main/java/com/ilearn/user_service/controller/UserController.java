...
public class UserController {
	...
	@PatchMapping("/updateNewPassword/{userName}")
	public ApiResponse updateNewUser(@PathVariable String userName,@RequestBody UserModel userModel) {
		return userService.updateNewUser(userName,userModel);
	}
