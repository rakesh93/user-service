...
public class AppConstants {
	...
	public static final String USER_NAME = "UserName is Mandatory";
	public static final String PASSWORD = "Password is Mandatory";
	public static final String FIRST_NAME = "FirstName is Mandatory";
	public static final String LAST_NAME = "LastName is Mandatory";
	public static final String EMAIL_ID = "EmailId is Mandatory";
	public static final String MOBILE_NO = "Mobile Number is Mandatory";
	public static final String ROLE = "Role is Mandatory";
